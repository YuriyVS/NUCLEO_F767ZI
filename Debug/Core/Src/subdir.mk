...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/AI_Normalisation.cyclo ./Core/Src/AI_Normalisation.d ./Core/Src/AI_Normalisation.o ./Core/Src/AI_Normalisation.su ./Core/Src/AO_Normalisation.cyclo ./Core/Src/AO_Normalisation.d ./Core/Src/AO_Normalisation.o ./Core/Src/AO_Normalisation.su ./Core/Src/Block_Sifu.cyclo ./Core/Src/Block_Sifu.d ./Core/Src/Block_Sifu.o ./Core/Src/Block_Sifu.su ./Core/Src/Block_Synhro.cyclo ./Core/Src/Block_Synhro.d ./Core/Src/Block_Synhro.o ./Core/Src/Block_Synhro.su ./Core/Src/DB_Constants.cyclo ./Core/Src/DB_Constants.d ./Core/Src/DB_Constants.o ./Core/Src/DB_Constants.su ./Core/Src/DB_Main.cyclo ./Core/Src/DB_Main.d ./Core/Src/DB_Main.o ./Core/Src/DB_Main.su ./Core/Src/DB_Parameters.cyclo ./Core/Src/DB_Parameters.d ./Core/Src/DB_Parameters.o ./Core/Src/DB_Parameters.su ./Core/Src/DI_Block.cyclo ./Core/Src/DI_Block.d ./Core/Src/DI_Block.o ./Core/Src/DI_Block.su ./Core/Src/DO_Block.cyclo ./Core/Src/DO_Block.d ./Core/Src/DO_Block.o ./Core/Src/DO_Block.su ./Core/Src/Reg_System.cyclo ./Core/Src/Reg_System.d ./Core/Src/Reg_System.o ./Core/Src/Reg_System.su ./Core/Src/event_log.cyclo ./Core/Src/event_log.d ./Core/Src/event_log.o ./Core/Src/event_log.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f7xx_hal_msp.cyclo ./Core/Src/stm32f7xx_hal_msp.d ./Core/Src/stm32f7xx_hal_msp.o ./Core/Src/stm32f7xx_hal_msp.su ./Core/Src/stm32f7xx_it.cyclo ./Core/Src/stm32f7xx_it.d ./Core/Src/stm32f7xx_it.o ./Core/Src/stm32f7xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f7xx.cyclo ./Core/Src/system_stm32f7xx.d ./Core/Src/system_stm32f7xx.o ./Core/Src/system_stm32f7xx.su ./Core/Src/web_server.cyclo ./Core/Src/web_server.d ./Core/Src/web_server.o ./Core/Src/web_server.su
